...
#ifndef __MYC_RZG2UL_H
#define __MYC_RZG2UL_H
...
#define CONFIG_SYS_SDRAM_SIZE		(CONFIG_SYS_DDR3SIZE - DRAM_RSV_SIZE) //total 1GB
#define CONFIG_SYS_LOAD_ADDR		0x58000000
#define CONFIG_LOADADDR			CONFIG_SYS_LOAD_ADDR // Default load address for tfpt,bootp...
#define CONFIG_VERY_BIG_RAM
#define CONFIG_MAX_MEM_MAPPED		(CONFIG_SYS_DDR3SIZE - DRAM_RSV_SIZE)
