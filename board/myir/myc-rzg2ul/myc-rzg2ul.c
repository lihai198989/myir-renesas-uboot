...
int board_init(void)
{
	...
	gd->bd->bi_boot_params = CONFIG_SYS_TEXT_BASE + 0x50000;
       ...
       mdelay(140);
       // phy1 and phy2 reset ; P8_1 and P8_3
       *(volatile u32 *)(PFC_PMC18) &= 0xFFFFFFF5; /* Port func mode  GPIO  */
       *(volatile u32 *)(PFC_PM18) = (*(volatile u32 *)(PFC_PM18) & 0xFFFFFF33) | (1<<3) | (1<<7); /* Port output mode 0b10 */
       *(volatile u32 *)(PFC_P18) = (*(volatile u32 *)(PFC_P18) & 0xFFFFFFF5) | (1<<1) | (1<<3); //high
       mdelay(20);
       /*value*/
       *(volatile u32 *)(PFC_P18) = (*(volatile u32 *)(PFC_P18) & 0xFFFFFFF5); // low
       mdelay(13);
       *(volatile u32 *)(PFC_P18) = (*(volatile u32 *)(PFC_P18) & 0xFFFFFFF5) | (1<<1) | (1<<3); //high
